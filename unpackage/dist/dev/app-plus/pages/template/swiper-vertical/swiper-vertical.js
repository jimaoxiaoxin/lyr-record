...
(() => {
  ...
  // ../../../../../../Users/clement.lin.local/Documents/HBuilderProjects/test1/unpackage/dist/dev/.nvue/pages/template/swiper-vertical/swiper-vertical.js
  ...
  var _sfc_main = {
    ...
    methods: {
      ...
      updateVideo(isNext) {
        ...
        formatAppLog("log", "at pages/template/swiper-vertical/swiper-vertical.nvue:139", "v:" + this._videoIndex + " d:" + this._videoDataIndex + "; next v:" + this.getNextIndex(isNext) + " next d:" + this.getNextDataIndex(isNext));
      }
    }
  };
      ...
      (0, import_vue2.createElementVNode)("view", { class: "page" }, [
        (0, import_vue2.createVNode)(_component_swiper, {
          ...
          default: (0, import_vue2.withCtx)(() => [
            ((0, import_vue2.openBlock)(true), (0, import_vue2.createElementBlock)(import_vue2.Fragment, null, (0, import_vue2.renderList)($data.videoList, (item) => {
  ...
  var swiperVertical = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["styles", [_style_0]], ["__file", "/Users/clement.lin.local/Documents/HBuilderProjects/test1/pages/template/swiper-vertical/swiper-vertical.nvue"]]);
